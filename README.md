# yum packaging nvidia persistenced
...
Packaging templates for `yum` and `dnf` based Linux distros to build NVIDIA persistenced packages.

The `main` branch contains this README. The `.spec`, `.service`, and `.init` files can be found in the appropriate [rhel7](../../tree/rhel7), [rhel8](../../tree/rhel8), and [fedora](../../tree/fedora) branches.
...
* **Source code** location: [https://github.com/NVIDIA/nvidia-persistenced/releases](https://github.com/NVIDIA/nvidia-persistenced/releases)
  ...
  *ex:* [https://github.com/NVIDIA/nvidia-persistenced/archive/460.56.tar.gz](https://github.com/NVIDIA/nvidia-persistenced/archive/460.56.tar.gz)
